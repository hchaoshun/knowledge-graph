...
## 语言特性
- [可见性、有序性、内存屏障，c++/java volatile](https://chatgpt.com/share/681cc09a-3568-8000-a849-e79f6ed2cc57)


## Python
- [Python 的 with 语句详解](https://www.jb51.net/article/51045.htm)
- [详解python之反射机制](https://www.cnblogs.com/vipchenwei/p/6991209.html)
- [python中类的命名空间和面向对象的诸多问题](https://blog.csdn.net/heli200482128/article/details/74990347)
- [python单元测试框架pytest简介](https://blog.csdn.net/liuchunming033/article/details/46501653)
...
- [浅析 C++ 调用 Python 模块](https://blog.csdn.net/tobacco5648/article/details/50890106)
...
- [Python Type Hinting](https://realpython.com/lessons/type-hinting/)
...
- [Pick the right one: int vs. int64](https://yourbasic.org/golang/int-vs-int64/)
- [Accept function in argument with empty interface return type](https://stackoverflow.com/questions/32345760/accept-function-in-argument-with-empty-interface-return-type)
